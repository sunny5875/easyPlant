...
var plantsLazy: [Plant] = [
    ...
    Plant(이름: "스투키", 원산지: "아프리카 동부",과명: "백합과",생육온도: "18-27도", 광요구도: "중간 이상 높은 광도(800~10,000 Lux) 요구되어 거실 창측이나 발코니에서 키우는 것이 좋음", 물주기: "보통 한달에 한번정도 관수하며 겨울에는 두발에 한번 정도 관수하다.", 특징: "포름 알데히드 등 공기중의 유해 성분을 제거해주는 실내 공기 정화식물 중의 하나이다. \n\n음이온과 피톤치드 효과가 있어서 심신 안정과 스트레스 해소에 도움을 준다는 선인장이다. \n\n직사광선에도 강하고 음지에서도 잘자라 통풍이 잘되는 밝은 집안에서도 잘 자라는 키우기 쉬운 식물이다. \n\n뿌리가 짧고 약해 물관리를 잘 못하며 쉽게 상하여 물을 주지 않는 것이 잘 키우는 방법 중 하나이다.", 한줄설명: "  귀차니즘은 이거 강추")
