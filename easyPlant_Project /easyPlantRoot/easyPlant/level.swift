...
let levels: [level] = [level(name: "일반인", hapiness: 0, numPlants: 0,
                       ...
                       level(name: "진정한 농부", hapiness: 95, numPlants: 15, growingDays: 720, icon: "나무", description: "축하드립니다. 이제 당신도 진정한 농부! 1년동안 식물의 행복을 유지해서 Easy Planter에 도전하세요!"),
                       level(name: "Easy Planter", hapiness: 95, numPlants: 15, growingDays: 1080, icon: "숲", description: "여기까지 오셨네요! 앞으로는 쭉 Easy Planter로서 식물을 행복하게 해주세요 (해당 단계 이후로는 단계가 떨어지지 않습니다.)")]
