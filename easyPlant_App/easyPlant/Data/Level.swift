...
let levels: [Level] = [Level(name: "일반인", hapiness: 0, numPlants: 0,growingDays: 0, icon: "person", description: "새롭게 식물을 등록해 보세요!"),
                       ...
                       Level(name: "초보 농부", hapiness: 70, numPlants: 3, growingDays: 60, icon: "leaf", description: "식물을 키우는 재미를 느끼셨나요? 다음 레벨을 향해 더 노력해봐요!"),
                       Level(name: "주니어 농부", hapiness: 80, numPlants: 6, growingDays: 180, icon: "flower", description: "여기까지 오느라 수고하셨어요~ 한 단계 성장한 농부가 되셨네요!"),
                       Level(name: "숙련된 농부", hapiness: 90, numPlants: 10, growingDays: 360, icon: "apple", description: "1년동안 당신의 식물들과 행복한 시간 보내셨나요? 이제 식물들을 돌보는 것에 익숙해졌을거라 생각해요."),
